...
export const AVAILABLE_MODELS: AIModel[] = [
  ...
  // --- DEPRECATED OR RETIRED MODELS (Comment/uncomment to toggle) ---
  // { id: "google/gemini-2.5-flash", name: "Gemini 2.5 Flash", provider: "Google" }, // Deprecated - Oct 16, 2026
  // { id: "groq/llama-3.3-70b-versatile", name: "Llama 3.3 70B", provider: "Groq" }, // Deprecated - Aug 16, 2026
