        ...
        {items.map((item, idx) => {
          return (
            <button
              ...
              className="group flex w-62 shrink-0 cursor-pointer flex-col gap-1 rounded-2xl border border-border bg-card px-4 py-3.5 text-left shadow-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:w-[320px] lg:gap-2 lg:px-5 lg:py-4 dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.2)]"
              key={idx}
            >
