  ...
  return (
    <div className="flex items-center">
      <m.div
        ...
        className="size-2 rounded-full bg-neutral-200 shadow-md dark:bg-neutral-500"
      />
      <m.div
        initial={{
          x: 0,
        ...
        className="size-2 -translate-x-2 rounded-full bg-neutral-200 shadow-md dark:bg-neutral-500"
      />
      <m.div
        initial={{
          x: 0,
        ...
        className="size-2 -translate-x-4 rounded-full bg-neutral-200 shadow-md dark:bg-neutral-500"
      />
    </div>
  )
}
