...
export function HeroSection() {
  ...
  return (
    <m.div variants={sectionVariants} className="flex flex-col space-y-4">
      {/* Avatar + availability badge container */}
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <Avatar className="size-20 border-2 border-primary/75 p-0.5 transition-colors duration-300 xl:size-24">
