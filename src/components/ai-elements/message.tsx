...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:max-w-[65%] group-[.is-user]:rounded-tr-xs group-[.is-user]:rounded-br-xl group-[.is-user]:bg-primary group-[.is-user]:text-primary-foreground lg:group-[.is-user]:max-w-1/2",

      "group-[.is-assistant]:rounded-tl-xs group-[.is-assistant]:rounded-bl-xl group-[.is-assistant]:bg-card group-[.is-assistant]:text-card-foreground",
      className
    )}
    {...props}
  >
